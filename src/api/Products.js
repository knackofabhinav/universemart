export const productlist = [
    {
        ...
        description: {
            ...
            review: [`In this age of manufactured outrage and constant distraction, the ability to choose the focused inner stillness that Ryan champions is more important than ever. (The Subtle Art of Not Giving a F*ck)`,
        ...
        description: {
            ...
            review: [`Entertaining and profound: page-turning neuroscience from a bit of a genius ― * GUARDIAN *`, 
        ...
        description: {
            ...
            review: [`A sui generis kind of personal trainer for the soul.... It's a good thing that there's space on the self-help shelves for a book as bracingly pessimistic as this one... Peterson offers an invaluable reminder that we're finite and inherently imperfect -- Oliver Burkeman ― Guardian (Book of the Week)`, 
        ...
        description: {
            ...
            review: [`It's one of the hardest books I have ever attempted to read. Each Aphorism requires multiple readings. Either that or I am just too thick headed for the ideas and the language in the book. But if you are looking for some intellectual stimulation this book checks all the right ones.`, 
        ...
        description: {
            ...
            review: [`It's a damn good book , not just for js but also anyone going into programming at beginner to intermediate level.`, 
        ...
        description: {
            ...
            review: [`A hopeful book about the potential for human progress when we work off facts rather than our inherent biases. -- Barack Obama`,
        ...
        description: {
            ...
            review: [`David Epstein manages to make me thoroughly enjoy the experience of being told that everything I thought about something was wrong. I loved Range -- Malcolm Gladwell, author of Outliers`, `Fabulous . . . If you are interested in champions' journeys, this is for you -- Judy Murray on Twitter`, `It’s a joy to spend hours in the company of a writer as gifted as David Epstein. And the joy is all the greater when that writer shares so much crucial and revelatory information about performance, success, and education -- Susan Cain, author of Quiet`, `An urgent and important book, an essential read for bosses, parents, coaches, and anyone who cares about improving performance -- Daniel H. Pink, author of Drive and To Sell is Human`]
        }
    }
];